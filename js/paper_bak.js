	var numberOfGradients = numberOfGradients(2); //param is default value
	...
	**/
	function createGradients(element, browser) {
		...
		var output;
		var texture = "url('img/paper_background.jpg')";
		var elementHeight = element.height();
		var gradientMinHeight = 200;
		var opacity = 0.75;
		...
		function numberOfGradients(defaultValue){
			//Calculate number of gradient stops
			if (elementHeight >= gradientMinHeight) {

				//Makes sure that gradients are not short than gradientMinHeight
				var num = Math.floor(elementHeight / gradientMinHeight);
